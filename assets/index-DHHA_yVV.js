(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function r(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(e){if(e.ep)return;e.ep=!0;const i=r(e);fetch(e.href,i)}})();const c={yougain:{title:"YouGain — Distributor Application",subtitle:"ATILIM LLC is seeking distribution partners for YouGain safety gloves.",who:"We are looking for country distributors in Europe and regional distributors in Africa.",geoNote:"First we separate as <strong>Europe</strong> and <strong>Africa</strong> and call it <strong>(EMEA)</strong>. We continue as <strong>EMEA</strong> below.",targetsHtml:`
      <ul>
    ...
    `,roleLabel:"Become a Partner (Solar)"}};function d(){const t=(new URLSearchParams(window.location.search).get("division")||"yougain").toLowerCase();return t==="industrial"||t==="promotional"||t==="solar"||t==="yougain"?t:"yougain"}function p(s){return s.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function u(s){const t=d(),r=c[t];s.innerHTML=`
    <div class="apply_page">
      <div class="container">
        <div class="apply_header">
          <a class="apply_back" href="/#divisions">← Back</a>
          <h1 class="apply_title">${r.title}</h1>
          <p class="apply_subtitle">${r.subtitle}</p>
        </div>
        ...
        <div class="apply_grid">
          <div class="apply_card">
            ...
            <p>${r.who}</p>
            <div class="apply_note">${r.geoNote}</div>
            <h3>Targets</h3>
            ${r.targetsHtml}
          ...
          <div class="apply_card">
            ...
            <form class="apply_form" name="distributor-application" method="POST" data-netlify="true" netlify-honeypot="bot-field">
              ...
              <input type="hidden" name="division" value="${p(t)}" />
              ...
              <button class="apply_submit" type="submit">${r.roleLabel}</button>
  ...
  `;const a=s.querySelector("form"),e=s.querySelector(".apply_status");a.addEventListener("submit",async i=>{i.preventDefault(),e.textContent="Submitting…";try{const l=new FormData(a),n=new URLSearchParams(l).toString();if(!(await fetch("/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n})).ok)throw new Error("Network error");e.textContent="Thank you! Your application has been received.",a.reset()}catch{e.textContent="Sorry — submission failed. Please try again or email info@atilim.ge."}})}const o=document.querySelector("#app");if(!o)throw new Error("#app bulunamadı");if(location.pathname==="/apply")u(o);else{let s=function(){try{r||(r=new(window.AudioContext||window.webkitAudioContext));const a=r,e=a.createOscillator(),i=a.createGain();e.type="square",e.frequency.setValueAtTime(520,a.currentTime),i.gain.setValueAtTime(1e-4,a.currentTime),i.gain.exponentialRampToValueAtTime(.12,a.currentTime+.005),i.gain.exponentialRampToValueAtTime(1e-4,a.currentTime+.06),e.connect(i),i.connect(a.destination),e.start(),e.stop(a.currentTime+.07)}catch{}},t=function(a){a.classList.add("is-pressed"),window.setTimeout(()=>a.classList.remove("is-pressed"),140)};o.innerHTML=`
  <header class="topbar">
      ...
      <div class="cards">
        ...
        <div class="card pressable">
          ...
          <div class="card_links">
            <a class="card_link pressable_link" href="https://yougaingloves.com" target="_blank" rel="noopener">Visit brand site</a>
            <a class="card_link secondary pressable_link" href="/apply?division=yougain" >Become a Distributor</a>
          </div>
        </div>
        ...
        <div class="card pressable">
          ...
          <div class="card_links">
            ...
            <a class="card_link secondary pressable_link" href="/apply?division=industrial">Become a Distributor</a>
          </div>
        </div>
        ...
        <div class="card pressable">
          ...
          <div class="card_links">
            <a class="card_link pressable_link" href="https://example.com" target="_blank" rel="noopener">Visit Amazon store</a>
            <a class="card_link secondary pressable_link" href="/apply?division=promotional">Become a Reseller</a>
          </div>
        </div>
  ...
  <div class="card_links">
    <a class="card_link pressable_link" href="https://example.com" target="_blank" rel="noopener">Visit website</a>
    <a class="card_link secondary pressable_link" href="/apply?division=solar">Become a Partner</a>
  </div>
</div>
        ...
        <div class="card pressable">
          <h3>Terra Vitalis</h3>
          <p>Brand collaboration and digital presence. (No application button on this site.)</p>
  ...
  <div class="container">
    ...
    <div class="partners_grid" aria-label="Partners logos">
      <div class="partner_item">
        <img class="partner_img" src="/partners/yougain.png" alt="YouGain" loading="lazy" />
      </div>

      <div class="partner_item">
        <img class="partner_img" src="/partners/sca.png" alt="SCA" loading="lazy" />
      </div>

      <div class="partner_item">
        <img class="partner_img" src="/partners/dp.png" alt="DP Innovation" loading="lazy" />
      </div>

      <div class="partner_item">
        <img class="partner_img" src="/partners/atilim-arch.png" alt="ATILIM Architecture" loading="lazy" />
      </div>

      <div class="partner_item">
        <img class="partner_img terra_img" src="/partners/terra.png" alt="Terra Vitalis" loading="lazy" />
      </div>
    </div>
  </div>
</section>
...
`;let r=null;document.querySelectorAll(".pressable").forEach(a=>{a.addEventListener("pointerdown",()=>{s(),t(a)})}),document.querySelectorAll(".pressable_link").forEach(a=>{a.addEventListener("pointerdown",e=>{s();const i=e.currentTarget.closest(".card");i&&t(i)})})}
